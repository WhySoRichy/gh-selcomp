...
// Verificar autenticación básica (usuarios y admins)
if (!isset($_SESSION['usuario_id'])) {
    header('Location: /gh/index.php');
    exit;
}

// Obtener rol del usuario (case-insensitive)
$es_admin = false;
...
include_once __DIR__ . '/../administrador/csrf_protection.php';
...
if (!isset($conexion) || !$conexion) {
    ...
    exit('Servicio temporalmente no disponible. Intente más tarde.');
}

// Obtener estadísticas iniciales con manejo de errores
$estadisticas = [
    'total' => 0,
    'activas' => 0,
    'archivadas' => 0
...
<head>
    ...
    <link rel="stylesheet" href="/gh/notificaciones/css/styles.css?v=<?php echo time(); ?>">
...
<body>
    <?php include_once __DIR__ . '/../administrador/Modulos/navbar.php'; ?>
    
    <main class="dashboard-container">
        <!-- Header principal -->
        <header class="header-notificaciones">
            <div class="header-content">
                <h1><i class="fas fa-bell"></i> <?php echo $es_admin ? 'Sistema de Notificaciones' : 'Mis Notificaciones'; ?></h1>
                <p class="subtitle"><?php echo $es_admin ? 'Gestiona y administra las notificaciones del sistema' : 'Consulta las notificaciones enviadas por el sistema'; ?></p>
            </div>
        ...
        <div id="modal-notificacion" class="modal" style="display: none;">
            <div class="modal-content modal-large">
                ...
                <form id="form-notificacion" method="POST" action="javascript:void(0);" enctype="multipart/form-data">
        ...
        <div id="modal-respuestas" class="modal" style="display: none;">
            <div class="modal-content modal-respuestas">
                <div class="modal-header">
                    <h2>
                        <i class="fas fa-comments"></i> Centro de Respuestas
                    </h2>
                    <button class="modal-close" id="cerrar-modal-respuestas">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                
                <div class="modal-body">
                    <div class="respuestas-container" id="lista-respuestas">
                    ...
                    <div class="respuestas-form">
                        ...
                        <form id="form-respuesta" enctype="multipart/form-data">
                            <input type="hidden" id="respuesta-notificacion-id" name="notificacion_id">
                            <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
                            ...
                            <div class="form-group">
                                <textarea 
                                    ...
                                    maxlength="2000"
                                    required></textarea>
                                <small class="char-counter">0 / 2000 caracteres</small>
                            </div>
                            
                            <div class="form-group">
                                <label for="respuesta-archivo">
                                ...
                                <input 
                                    ...
                                    multiple>
                                <small class="file-info">
                                    Formatos permitidos: PDF, Word, Excel, Imágenes, ZIP, RAR
                                </small>
    ...
    <!-- Script del sistema -->
    <script type="module" src="/gh/notificaciones/js/app.js"></script>
</body>
</html>